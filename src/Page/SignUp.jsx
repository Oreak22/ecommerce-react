...
const SignUp = () => {
    ...
    let url= 'http://ecommerceserver24.vercel.app/user/register'
    const toOtherPage = ()=>{
        setIsLoading(true)
        console.log('tans')
    }
                ...
                <div className="row justify-content-lg-between justify-content-center align-items-center">
                    ...
                    <div className="col-lg-4 col-8">
                        ...
                        <div className="my-4">
                            ...
                            <button className="btn btn-outline-dark w-100 py-2 my-1 "><i className='me-3'><img src={googleIcon} alt="" /></i>Sign up with Google</button>
                        </div>
                        <div className='text-center d-flex justify-content-center'>
                            <span className='me-3'>Aready have account?</span> <Link to="/signin" className="active nav-link" onClick={toOtherPage}><span className="">Log In</span></Link>
                        </div>
                    </div>
                </div>
            </div>
