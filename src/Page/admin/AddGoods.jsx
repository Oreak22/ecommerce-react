...
const AddGoods = () => {
	...
	const goodsDetail = {
		...
		pic: {
			fullView: main_pic,
			otherView: [img1, img2, img3 && img3, img4 && img4],
		},
	};
			...
			<section className='container-lg py-5 mt-5'>
				<div className='cartbreadcrubs d-flex my-4 justify-content-between align-items-center'>
					<div className='d-flex'>
						<Link className='nav-link me-3' to='/admin/page/'>
							Page
						</Link>{" "}
						/ <p className='nav-link fw-bold ms-3'>Add2Goods</p>
					</div>
				</div>
				<div className='row py-5 pt-0 px-2'>
							...
							<div className='addPic'>
								<div className='row justify-content-center'>
									<div className='col-md-12'>
										<label
											htmlFor='Main_pic'
											className='fw-bold mb-3 p-3 justify-content-center d-flex align-items-center rounded-start-2 lh-4'
											style={{ border: "Solid thin black" }}
										>
											<div>
												{" "}
												<div
													className='rounded-2 mx-auto p-0 my-0 justify-content-center d-flex align-items-center'
													style={{
														height: "3rem",
														width: "3rem",
										...
										<input
											...
											className='d-none'
											id='Main_pic'
											onChange={(e) => handleFile({ e, setimg: setMain_pic })}
										/>
									</div>
									<div className='col-md-6 d-flex justify-content-center'>
										<div className='w-50'>
											<label
												htmlFor='img1'
												className='fw-bold mb-3 p-3 text-center  lh-4'
												style={{ border: "Solid thin black" }}
											>
												<div
													className='rounded-2 mx-auto p-0 my-0 justify-content-center d-flex align-items-center'
											...
											<input
												...
												className='d-none'
												id='img1'
												onChange={(e) => handleFile({ e, setimg: setImg1 })}
											/>
										</div>
										<div className='w-50'>
											<label
											...
											<input
												...
												className='d-none'
												id='img2'
												onChange={(e) => handleFile({ e, setimg: setImg2 })}
											/>
										</div>
										<div className='w-50'>
											<label
											...
											>
												...
												<input
													...
													className='d-none'
													id='img3'
													onChange={(e) => handleFile({ e, setimg: setImg3 })}
												/>
											</label>
										</div>
										<div className='w-50'>
											...
											<input
												...
												className='d-none'
												id='img4'
												onChange={(e) => handleFile({ e, setimg: setImg4 })}
											/>
										</div>
									</div>
								</div>
								<div className='alert alert-secondary text-center'>
									...
									Upload a main picture of the goods and a minimum of 2 sub
									picture
								</div>
							</div>
							<div className=''>
								...
								<div>
									...
									<div className='d-flex align-items-center'>
										...
										<input
											type='text'
											placeholder='Enter color (eg red or #f5f5f5)'
											value={colorstate}
								...
								<div>
									...
									<div className=''>
										...
										<div className='d-flex my-3'>
											{size.map((item, index) => (
												<button
													className='rounded-pill btn btn-outline-danger mx-2 shadow-sm text-uppercase'
													title={"Remove " + item}
													key={index}
										...
										>
											<option value='r' className='text-success'>
												R
											</option>
											{protentialSize.map((item, index) => (
												<option value={item} className='text-success'>
													{item}
												</option>
											))}
										</select>
					...
					<div className='col-md-8'>
						<div className='d-flex justify-content-center algin-item-center'>
							{res.message ? (
								res.status ? (
									<div className='alert alert-success text-center w-100 py-2'>
										{res.message}
									</div>
								) : (
									<div className='alert alert-danger text-center w-100 py-2'>
										{res.message}
									</div>
								)
							) : (
				...
				<div class='modal-dialog modal-dialog-centered'>
					<div class='modal-content'>
						...
						<div class='modal-body'>
							Make sure all things aare in good order, product will be displayed
							to customers as shown here. <br />
