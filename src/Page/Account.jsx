...
const Account = () => {
	...
	useEffect(() => {
		...
		if (JSON.parse(localStorage.getItem("exclusive"))) {
			const _id = {
				user_id: JSON.parse(localStorage.getItem("exclusive")).account_id,
			};
			axios
				.get(url, { headers: _id })
				.then((res) => {
			...
			<section className='container-lg my-md-5 py-2'>
				<div className='cartbreadcrubs pb-5 d-flex my-5 justify-content-between align-items-center'>
					<div className='d-flex'>
						...
						/ <Link className='nav-link fw-bold ms-3'>My Account</Link>
					</div>
					<div className=''>
						<strong>
							<small>
								Welcome!{" "}
								<span className='tx-red text-capitalize'>
									{user_data.uname}
								</span>
							</small>
						</strong>
				...
				<div className='row justify-content-between align-items-top'>
					<div className='col-md-2'>
						<div>
							<h4 className='header h5'>Manage My Account</h4>
							<div style={{ width: "fit-content" }} className=' mx-auto my-3'>
								<ul className='nav-navbar lh-lg'>
									<li className='nav-item'>
										<Link className='nav-link tx-red'>My Account</Link>
									</li>
									<li className='nav-item'>
										<Link className='nav-link'>Address Book</Link>
									</li>
									<li className='nav-item'>
										<Link className='nav-link'>My Payment Options</Link>
									</li>
								</ul>
							</div>
						</div>
						<div>
							<h4 className='header h5'>My Orders</h4>
							<div style={{ width: "fit-content" }} className=' mx-auto my-3'>
								<ul className='nav-navbar lh-lg'>
									<li className='nav-item'>
										<Link className='nav-link'>My Returns</Link>
									</li>
									<li className='nav-item'>
										<Link className='nav-link'>My Collections</Link>
									</li>
								</ul>
							</div>
						</div>
						<div>
							<h4 className='header h5'>
								<Link to='/mywishlist' className='nav-link'>
									My Wishlist
								</Link>
							</h4>
						</div>
						...
						<div className='py-md-2 px-md-2'>
							...
							<div className='row justify-content-between'>
								<div className='mb-3 col-md-6'>
									...
									<input
										type='text'
										className='form-control py-2 b-blue'
										value={uname}
								...
								<div className='mb-3 col-md-6'>
									...
									<input
										type='text'
										className='form-control py-2 b-blue'
										value={user_data.ulast_name}
										id='exampleInputEmail1'
										aria-describedby='emailHelp'
										onChange={(e) => setUlast_name(e.target.value)}
									/>
								</div>
								<div className='mb-3 col-md-6'>
									<label
								...
								<div className='mb-3 col-md-12'>
									<div className='mb-3'>
										...
										<input
											...
											className='form-control b-blue py-2'
								...
								<div className='d-flex justify-content-end'>
									<button className='btn-lg btn rounded-1 me-2 px-5'>
										Cancle
									</button>
									<button
										className='btn-lg btn-outline-danger btn text-light rounded-1 px-5 b-red'
										onClick={editDetails}
									>
										Save Changes
									</button>
